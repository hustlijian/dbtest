...
description:
    input data to sqlite database table
...
DB = 'dbtest.db'
DBTABLE = 'testtable'
HELP = '''usage: sqlite_test.py [-h] [-i count] [-q times]
desc.:
    [-h] --- get usage help
...
def insert():
    ...
    # create table
    command = 'CREATE TABLE IF NOT EXISTS %s (id integer primary key autoincrement,num integer)'%(DBTABLE)
